...
echo "   so certs already installed for another of your projects can be reused here."
echo ""
...
echo ""
echo "   Prompts pre-fill from any existing 'put-release' values, so re-running it to"
echo "   change one credential means pressing Enter through the rest."
echo "   Needs an interactive terminal; it refuses to run when stdin is not a tty."
echo ""
echo "4. Verify:"
